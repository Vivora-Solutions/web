        ...
        <div className="space-y-8">
          ...
          <section className="bg-white rounded-xl shadow-sm border border-slate-200 p-8">
            <h2 className="text-2xl font-bold text-slate-900 mb-6 flex items-center">
              <span className="bg-gray-100 text-gray-800 w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold mr-3">
                1
              </span>
              Scope of Services
            </h2>
          ...
          <section className="bg-white rounded-xl shadow-sm border border-slate-200 p-8">
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
              <h3 className="font-bold text-gray-900 mb-3">No-shows:</h3>
          ...
          <section className="bg-white rounded-xl shadow-sm border border-slate-200 p-8">
            ...
            <ul className="space-y-3 text-slate-700">
              ...
              <li className="flex items-start">
                <span className="w-2 h-2 bg-gray-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>A separate Privacy
          ...
          {/* Section 11 - Contact */}
          <section className="bg-gradient-to-r from-gray-50 to-indigo-50 rounded-xl border border-gray-200 p-8">
            <h2 className="text-2xl font-bold text-slate-900 mb-6 flex items-center">
              <span className="bg-gray-100 text-gray-800 w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold mr-3">
                11
              </span>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <a href="tel:0766787578" className="text-gray-600 hover:text-gray-800 transition-colors">
                    0766787578
                  </a>
                </div>
              </div>
