      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="space-y-6 sm:space-y-8">
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 transition-all hover:shadow-xl">
            ...
            <p className="text-gray-700 leading-relaxed mt-4 font-medium bg-yellow-50 p-3 rounded-lg border-l-4 border-yellow-400">
          ...
          {[
            ...
            <section key={index} className="bg-white rounded-2xl shadow-md p-6 border border-gray-100 transition-all hover:shadow-lg">
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-200 flex items-center">
                <span className="bg-gradient-to-r from-purple-500 to-indigo-600 text-white rounded-full w-8 h-8 flex items-center justify-center text-sm mr-3">
                  {index + 1}
                </span>
                {section.title}
              </h2>
              ...
              <ul className="space-y-3 text-gray-700">
                {section.items.map((item, itemIndex) => (
                  <li key={itemIndex} className="flex items-start gap-3">
                    <span className={`w-2 h-2 rounded-full mt-3 flex-shrink-0 ${section.warning ? 'bg-red-500' : 'bg-indigo-500'}`}></span>
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
              ...
              {section.note && (
                <p className="text-sm text-red-600 bg-red-50 p-3 rounded-lg mt-4 border-l-4 border-red-400">
            ...
            <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
              <div className="space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                  ...
                  <a href="mailto:vivorasolutions@gmail.com" className="text-indigo-600 hover:underline font-medium flex items-center">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                  ...
                  <a href="tel:0766787578" className="text-indigo-600 hover:underline font-medium flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
