...
//         <div className="w-full max-w-lg bg-white rounded-3xl shadow-2xl border border-gray-100 p-8 flex flex-col items-center space-y-6 transform transition-all duration-300 hover:scale-[1.01]">
//           {!confirmed ? (
//             <>
...
//               </div>
//               <div className="w-full border-t border-gray-200 pt-6 space-y-4 text-gray-700">
