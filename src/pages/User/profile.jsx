...
//               <p className="border px-3 py-2 rounded bg-gray-100">{userData.email}</p>
//             </div>
//             <div>
//               <p className="font-semibold">Contact Number:</p>
//               <p className="border px-3 py-2 rounded bg-gray-100">{userData.customer.contact_number}</p>
//             </div>
//             <div>
//               <p className="font-semibold">First Name:</p>
//               <p className="border px-3 py-2 rounded bg-gray-100">{userData.customer.first_name}</p>
//             </div>
//             <div>
//               <p className="font-semibold">Last Name:</p>
//               <p className="border px-3 py-2 rounded bg-gray-100">{userData.customer.last_name}</p>
//             </div>
//             <div>
//               <p className="font-semibold">Date of Birth:</p>
//               <p className="border px-3 py-2 rounded bg-gray-100">{userData.customer.date_of_birth}</p>
//             </div>
//           </div>
...
//                 readOnly
//                 className="mt-1 w-full border border-gray-200 bg-gray-100 p-2 rounded"
//               />
//             </div>
//             <div>
