          ...
          {[
            ...
            <section key={index} className="bg-white rounded-2xl shadow-md p-6 border border-gray-100 transition-all hover:shadow-lg">
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-200 flex items-center">
                <span className="bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-full w-8 h-8 flex items-center justify-center text-sm mr-3">
                  {index + 1}
                </span>
                {section.title}
              </h2>
                    ...
                    <div key={subIndex}>
                      ...
                      {subsection.note && (
                        <div className="bg-blue-50 border-l-4 border-blue-400 p-4 mt-4 rounded-r-lg">
                          <p className="text-blue-800">{subsection.note}</p>
                        </div>
                      )}
                    </div>
                  ))}
            ...
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
              <div className="space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                  ...
                  <a href="mailto:vivorasolutions@gmail.com" className="text-blue-600 hover:text-blue-800 font-medium flex items-center">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                  ...
                  <a href="tel:0766787578" className="text-blue-600 hover:text-blue-800 font-medium flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
