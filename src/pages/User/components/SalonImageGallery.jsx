...
//         alt="Default Banner"
//         className="w-full h-72 md:h-[36rem] object-cover rounded-2xl"
//       />
//     );
//   }
...
//   return (
//     <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-2 flex flex-col md:flex-row gap-4 w-full h-auto md:h-[36rem]">
//       {/* Left: Main Image */}
//       <div className="w-full md:w-2/3 flex items-center justify-center h-72 md:h-full">
//         <img
...
//       {/* Right: Thumbnails (No Overflow, Full Height) */}
//       <div className="w-full md:w-1/3 flex flex-col gap-2 h-72 md:h-full">
...
//               className={`cursor-pointer object-cover rounded-xl border w-full h-full ${
