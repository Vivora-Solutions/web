...
const About = () => {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-50 via-gray-50 to-gray-100 relative overflow-hidden">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-gradient-to-br from-gray-400/20 to-gray-400/20 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute top-1/2 -left-40 w-80 h-80 bg-gradient-to-br from-gray-400/20 to-gray-400/20 rounded-full blur-3xl animate-pulse animation-delay-1000"></div>
      ...
      <div className="flex-grow">
        <div className="relative py-5 overflow-hidden bg-gradient-to-r from-gray-500 via-gray-500 to-gray-400">
          <div className="absolute inset-0 bg-black/10"></div>
          <div className="relative container mx-auto px-4">
            <div className="text-center text-white max-w-4xl mx-auto">
              <h1 className="text-5xl md:text-7xl font-bold mb-8 leading-tight animate-fade-in-up">
                About{" "}
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-gray-300 via-gray-300 to-gray-300 animate-gradient-x">
                  Vivora
                </span>
              </h1>
              ...
              {/* <div className="absolute inset-0 overflow-hidden">
                <div className="absolute top-20 left-10 w-2 h-2 bg-gray-300 rounded-full animate-float"></div>
                <div className="absolute top-32 right-20 w-3 h-3 bg-gray-300 rounded-full animate-float animation-delay-1000"></div>
                ...
                <div className="absolute top-16 left-1/3 w-72 h-72 bg-gradient-to-r from-gray-400/30 to-gray-400/30 rounded-full mix-blend-overlay filter blur-xl animate-blob"></div>
                <div className="absolute top-20 right-1/4 w-72 h-72 bg-gradient-to-r from-gray-400/30 to-gray-400/30 rounded-full mix-blend-overlay filter blur-xl animate-blob animation-delay-2000"></div>
                <div className="absolute bottom-10 left-1/5 w-72 h-72 bg-gradient-to-r from-gray-400/30 to-gray-400/30 rounded-full mix-blend-overlay filter blur-xl animate-blob animation-delay-4000"></div>
              </div> */}
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-20 relative z-10">
          ...
          <div className="max-w-5xl mx-auto bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl p-10 md:p-12 mb-20 transition-all duration-500 hover:shadow-3xl hover:bg-white/90 group animate-fade-in-up">
            <div className="flex items-center mb-8">
              <div className="h-12 w-1.5 bg-gradient-to-b from-gray-500 via-gray-500 to-gray-400 rounded-full mr-6 group-hover:scale-110 transition-transform duration-300"></div>
              <h2 className="text-4xl font-bold text-gray-800 group-hover:text-gray-600 transition-colors duration-300">
                Our Story
              </h2>
            </div>
            ...
            <div className="space-y-6 text-lg leading-relaxed">
              <p className="text-gray-700 animate-fade-in-up animation-delay-100">
                ...
                <span className="italic font-semibold text-transparent bg-clip-text bg-gradient-to-r from-gray-500 to-gray-500">
                  {" "}
              ...
              <p className="text-gray-700 animate-fade-in-up animation-delay-200">
                ...
                <span className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-gray-500 to-gray-500">
                  Vivora Solutions
                </span>
                .
              </p>
