...
import { isDaySelected, formatDateToString } from "./timeUtils";

export const DaySelectionView = ({
  weekDates,
  selectedLeaveDays,
  handleDayClick,
}) => {
        ...
        <div style={{ padding: "32px" }}>
          ...
          >
            {weekDates.map((date, index) => {
              const isSelected = isDaySelected(date, selectedLeaveDays);
                ...
                <div
                  ...
                  style={{
                    background: isSelected
                      ...
                      : "white",
                    border: `3px solid ${
                      isSelected ? COLORS.leave : isToday ? COLORS.info : COLORS.border
                    }`,
                    borderRadius: "16px",
                    padding: "24px 16px",
                    textAlign: "center",
