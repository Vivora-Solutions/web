...
import { User, Calendar, Settings, Trash2, CheckCircle } from "lucide-react"

const StylistCard = ({ stylist, onManageSchedule, onManageServices, onDisableStylist, onActivateStylist }) => {
  return (
      ...
      {stylist.is_active ? (
        ...
        <div>
          <button
            ...
            className="p-2.5 rounded-lg bg-green-100 text-red-600 hover:bg-green-200 hover:scale-105 transition-all"
