  ...
  const handleLogoUpload = async (e) => {
    ...
    try {
      ...
      errorNotification.innerHTML = `
        ...
        <span>Failed to upload logo</span>
      `;
  ...
  const handleUpdate = async () => {
    try {
      ...
      notification.innerHTML = `
        ...
        <span>Salon updated successfully!</span>
      `;
      document.body.appendChild(notification);
      setTimeout(() => {
        notification.classList.add("opacity-0", "transition-opacity", "duration-500");
      ...
      errorNotification.innerHTML = `
        ...
        <span>Failed to update salon: ${err.response?.data?.error || err.message}</span>
      `;
      document.body.appendChild(errorNotification);
      setTimeout(() => {
        errorNotification.classList.add("opacity-0", "transition-opacity", "duration-500");
    ...
    return (
      <div className="p-6 bg-gradient-to-br from-pink-50 via-purple-50 to-indigo-50 rounded-xl shadow-lg border border-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          ...
          <div className="bg-white/60 rounded-lg p-4 animate-pulse">
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="h-4 bg-gray-100 rounded w-20 mb-1"></div>
                <div className="h-10 bg-gray-200 rounded w-full"></div>
              </div>
              <div>
        ...
        <div className="bg-white/60 rounded-lg p-4 mb-6 animate-pulse">
