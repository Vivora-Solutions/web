...
const PhotoSection = () => {
  ...
  const confirmDeletePhoto = async () => {
    ...
    if (index === null || !photos[index]?.image_id) return;
  ...
  return (
    <div className="p-6 bg-white rounded-xl shadow relative">
      ...
      {showConfirmModal && (
        <>
          {/* Overlay */}
          <div className="fixed inset-0  bg-opacity-50 z-40 animate-fadeIn" onClick={() => setShowConfirmModal(false)}></div>
          ...
          <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-black bg-opacity-40 backdrop-blur-md rounded-lg shadow-xl p-6 z-50 w-full max-w-sm animate-fadeIn">
            <div className="text-center">
              ...
              <p className="text-gray-200 mb-6">Are you sure you want to delete this photo? This action cannot be undone.</p>
