    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 py-8 px-4">
      ...
      <div className="max-w-4xl mx-auto mb-8 text-center">
        ...
        <p className="text-gray-600 text-base md:text-lg max-w-2xl mx-auto">
          Join our platform and showcase your salon to customers. Create your professional
      ...
      <div className="max-w-4xl mx-auto">
        <div className="shadow-lg border bg-white rounded-3xl overflow-hidden">
          <div className="text-center py-6 px-4 md:px-8 border-b">
            <h2 className="text-xl md:text-2xl font-semibold text-gray-800">Create Your Account</h2>
            <p className="text-gray-500 text-sm md:text-base">Fill in your salon details to get started</p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="h-12 w-full rounded-md border px-4 focus:outline-none focus:ring-2 focus:ring-gray-400"
                    />
                  </div>
              ...
              <div className="space-y-4">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  required
                  className="min-h-[100px] w-full rounded-md border px-4 py-2 focus:outline-none focus:ring-2 focus:ring-gray-400 resize-none"
                />
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 p-4 rounded-lg text-sm">
                  <p className="text-gray-600 mb-2">
                    ...
                    Click on the map to set your salon's location.
                  </p>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full h-12 bg-gradient-to-r from-gray-700 to-gray-600 hover:from-gray-800 hover:to-gray-700 text-white font-medium shadow-md hover:shadow-lg transition-all duration-200 rounded-md flex justify-center items-center"
              >
                {loading ? (
                  <>
