  ...
  useEffect(() => {
    const handleOAuthCallback = async () => {
      ...
      try {
        ...
        if (roleError) {
          // If user doesn't exist in the 'user' table, they might need to be registered
          if (roleError.message.includes("No rows found")) {
            redirectToLogin("User account not found. Please sign up first.");
          } else {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-brown-50 to-brown-100 p-4 overflow-hidden relative">
      ...
      <div className="z-10 bg-white rounded-2xl shadow-2xl p-10 max-w-md w-full border border-gray-100">
        <div className="text-center">
          ...
          {/* Title */}
          <h2 className="text-3xl font-bold text-gray-800 mb-3">Authentication in Progress</h2>
          ...
          <div className="space-y-3 mb-6">
            <div className="flex items-center">
              ...
              <span className="text-sm text-gray-700">Connecting to Google</span>
            </div>
            ...
            <div className="flex items-center">
              ...
              <span className="text-sm text-blue-700 font-medium">Setting up your session</span>
            </div>
          </div>
          
          {/* Loading bar */}
          <div className="w-full bg-gray-200 rounded-full h-1.5 mb-8 overflow-hidden">
            <div className="bg-gradient-to-r from-black to-[#8B4513] h-1.5 rounded-full animate-pulse" style={{width: '75%'}}></div>
          </div>
          
          {/* Message */}
          <p className="text-sm text-gray-500 italic">
            You'll be automatically redirected once the authentication is complete.
